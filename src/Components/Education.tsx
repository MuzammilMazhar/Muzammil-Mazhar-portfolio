    ...
    return(
        ...
        <h1 className=" text-[35px] md:text-[50px] text-white font-bold text-center">
            ...
            <button className="text-green-300 border-2 p-2  border-green-300 ">2023 - 2024</button>
               ...
               <p className="text-gray-400 px-0 py-2 text-left content-stretch">I am Muzammil Mazhar, a passionate learner currently expanding my frontend expertise in Next.js and Tailwind CSS at PIAIC institute, an institute I m grateful for, fostering exceptional skill development.</p>
           </div>
           <div className="p-5 ">
